...
var _a3$5;
var EmptyResponseBodyError$5 = class EmptyResponseBodyError extends AISDKError$5 {
  // used in isInstance
  ...
  static isInstance(error) {
    return AISDKError$5.hasMarker(error, marker3$5);
  }
};
_a3$5 = symbol3$5;
...
var _a8$4;
var LoadAPIKeyError$4 = class LoadAPIKeyError extends AISDKError$5 {
  // used in isInstance
  constructor({ message }) {
  ...
  static isInstance(error) {
    return AISDKError$5.hasMarker(error, marker8$4);
  }
};
_a8$4 = symbol8$4;
...
var generateId$5 = createIdGenerator$5();
...
var anthropicFailedResponseHandler = createJsonErrorResponseHandler$5({
      ...
      case "provider-defined": {
        switch (tool.id) {
          ...
          case "anthropic.text_editor_20250728": {
            const args = await validateTypes$5({
              value: tool.args,
              ...
              case "tool-result": {
                if (part.toolName === "code_execution") {
                  ...
                  if (output.value.type === "code_execution_result") {
                    const codeExecutionOutput = await validateTypes$5({
                      value: output.value,
                ...
                if (part.toolName === "web_fetch") {
                  ...
                  const webFetchOutput = await validateTypes$5({
                    value: output.value,
                ...
                if (part.toolName === "web_search") {
                  ...
                  const webSearchOutput = await validateTypes$5({
                    value: output.value,
...
var _a3$4;
var EmptyResponseBodyError$4 = class EmptyResponseBodyError extends AISDKError$4 {
  // used in isInstance
  constructor({ message = "Empty response body" } = {}) {
  ...
  static isInstance(error) {
    return AISDKError$4.hasMarker(error, marker3$4);
  }
};
_a3$4 = symbol3$4;
...
var _a8$3;
var LoadAPIKeyError$3 = class LoadAPIKeyError extends AISDKError$4 {
  // used in isInstance
  constructor({ message }) {
  ...
  static isInstance(error) {
    return AISDKError$4.hasMarker(error, marker8$3);
  }
};
_a8$3 = symbol8$3;
...
var generateId$4 = createIdGenerator$4();
...
var googleFailedResponseHandler = createJsonErrorResponseHandler$4({
...
var GoogleGenerativeAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    const mergedHeaders = combineHeaders$4(
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: createJsonResponseHandler$4(responseSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
  ...
  async doStream(options) {
    const { args, warnings } = await this.getArgs(options);
    const body = JSON.stringify(args);
    const headers = combineHeaders$4(
      await resolve(this.config.headers),
      options.headers
    );
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerate(options) {
    ...
    const { responseHeaders, value: response } = await postJsonToApi$4({
      ...
      headers: combineHeaders$4(await resolve(this.config.headers), headers),
      body,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: createJsonResponseHandler$4(
...
function createGoogleGenerativeAI(options = {}) {
  ...
  const getHeaders = () => withUserAgentSuffix$3(
    {
...
var _a3$3;
var EmptyResponseBodyError$3 = class EmptyResponseBodyError extends AISDKError$3 {
  // used in isInstance
  constructor({ message = "Empty response body" } = {}) {
  ...
  static isInstance(error) {
    return AISDKError$3.hasMarker(error, marker3$3);
  }
};
_a3$3 = symbol3$3;
...
var _a5$2;
var InvalidPromptError$2 = class InvalidPromptError extends AISDKError$3 {
  constructor({
    prompt,
    message,
    cause
  ...
  static isInstance(error) {
    return AISDKError$3.hasMarker(error, marker5$2);
  }
};
_a5$2 = symbol5$2;
...
var _a6$2;
var InvalidResponseDataError$2 = class InvalidResponseDataError extends AISDKError$3 {
  constructor({
    data,
  ...
  static isInstance(error) {
    return AISDKError$3.hasMarker(error, marker6$2);
  }
};
_a6$2 = symbol6$2;
...
var _a12$1;
var TooManyEmbeddingValuesForCallError$1 = class TooManyEmbeddingValuesForCallError extends AISDKError$3 {
  constructor(options) {
    super({
      name: name11$1,
      message: `Too many values for a single embedding call. The ${options.provider} model "${options.modelId}" can only embed up to ${options.maxEmbeddingsPerCall} values per call, but ${options.values.length} values were provided.`
...
var generateId$3 = createIdGenerator$3();
...
var OpenAICompatibleChatLanguageModel = class {
  ...
  constructor(modelId, config) {
    ...
    this.failedResponseHandler = createJsonErrorResponseHandler$3(errorStructure);
...
var OpenAICompatibleEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    const {
      ...
      failedResponseHandler: createJsonErrorResponseHandler$3(
...
function createOpenAICompatible(options) {
  ...
  const getHeaders = () => withUserAgentSuffix$2(headers, `ai-sdk/openai-compatible/${VERSION$4}`);
...
var _a3$2;
var EmptyResponseBodyError$2 = class EmptyResponseBodyError extends AISDKError$2 {
  // used in isInstance
  constructor({ message = "Empty response body" } = {}) {
  ...
  static isInstance(error) {
    return AISDKError$2.hasMarker(error, marker3$2);
  }
};
_a3$2 = symbol3$2;
...
var _a5$1;
var InvalidPromptError$1 = class InvalidPromptError extends AISDKError$2 {
  constructor({
    prompt,
    message,
    cause
...
var _a6$1;
var InvalidResponseDataError$1 = class InvalidResponseDataError extends AISDKError$2 {
  constructor({
    data,
    message = `Invalid response data: ${JSON.stringify(data)}.`
  }) {
...
var _a8$2;
var LoadAPIKeyError$2 = class LoadAPIKeyError extends AISDKError$2 {
  // used in isInstance
  constructor({ message }) {
  ...
  static isInstance(error) {
    return AISDKError$2.hasMarker(error, marker8$2);
  }
};
_a8$2 = symbol8$2;
